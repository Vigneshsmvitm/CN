...
public class CRCDemoo {
  ...
  static int mlen,glen,c,x,flag=0,test;
  ...
  public static void main(String[] args){
    ...
    System.out.println("Predefined Generated Polynomial is:"+genPoly);
    ...
    if(test==1){
      ...
      System.out.println("Erroreous data"+new String(t));
